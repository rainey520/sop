...
public interface IDevProductListService 
{
	 ...
	 * @return
	 */
	List<DevProductList> selectNotConfigByLineId(Integer lineId,Integer companyid,Integer sopTag,Integer isoId);
	 ...
	 * @return
	 */
	List<DevProductList> selectSopConfigBySid(Integer sid,Integer companyId);
