...
public class LoginController extends BaseController {
    ...
    @PostMapping("/login")
    @ResponseBody
    public AjaxResult ajaxLogin(String username, String password, Boolean rememberMe,Integer languageVersion) {
        try {
            return loginService.login(username,password,languageVersion);
